...
var content = {
    ...
    fr: {
      ...
      howtomakemoney: "Comment voulez vous faire de l'argent en ligne sans une bonne COMMUNICATION, vous devez transmettre un message, une bonne image de vous, et faire cela de manière à faire acheter, c'est un savoir faire que nous avons.",
      schedule: "APPEL GRATUIT",
      offer: "Le service qu'on offre:",
      whatisit: "Qu'est ce que c'est, et comment ca peut vous aider ?",
      text1: "Nous faisons UNE chose - et on le fait avec une concentration monastique, mieux que n'importe qui. Le copywriting est l'art d'écrire des textes qui vous font gagner plus d'argent , en d'autres termes, inciter les clients à agir. Si vous voulez savoir à quoi ça ressemble, ce site web est un bon exemple.",
      text2: "",
